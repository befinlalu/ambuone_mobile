...
class SosAccessibilityService : AccessibilityService() {
    ...
    private val keepAlive = object : Runnable {
        override fun run() {
            try {
                ...
                Log.e("SosAccessibility", "Keep-alive error (Ignored): ${e.message}")
            }
    ...
    override fun onServiceConnected() {
        try {
            ...
            // Initialize WakeLock with a 10-minute timeout safely
            ...
            Log.d("SosAccessibility", "Service connected safely — WakeLock + Keep-alive active")
        } catch (e: Exception) {
            Log.e("SosAccessibility", "Crash prevented in onServiceConnected: ${e.message}")
        }
    }
    ...
    override fun onKeyEvent(event: KeyEvent): Boolean {
        try {
            ...
            Log.e("SosAccessibility", "Crash prevented in onKeyEvent: ${e.message}")
        }
        return false
    }
    ...
    private fun triggerVibration() {
        try {
            ...
            Log.e("SosAccessibility", "Vibration error ignored: ${e.message}")
        }
    }
    ...
    private fun launchSosPage() {
        try {
            ...
            startActivity(intent)
             ...
             Log.e("SosAccessibility", "Launch SOS Page error ignored: ${e.message}")
        }
    }
    ...
    override fun onDestroy() {
        try {
            ...
            super.onDestroy()
            Log.d("SosAccessibility", "Service destroyed safely — WakeLock released")
        } catch (e: Exception) {
            Log.e("SosAccessibility", "Destroy error ignored: ${e.message}")
        }
    }
